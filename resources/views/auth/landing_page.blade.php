...
.customized-row {
    ...
    min-height: 100vh;
    width: 100%;
    background: linear-gradient(90deg, rgba(0, 0, 0, 0.00) 0%, #1C1C1C 100%), url('{{ asset('img/clientclinic.jpg') }}') lightgray 0px -54.5px / cover no-repeat;
}
        ...
        <div class="container-fluid">
            ...
            <div class="row customized-row d-flex align-items-center justify-content-end">
                <div class="customized-col col-8 col-md-6 mt-4 mt-md-0 d-flex flex-column justify-content-center align-items-start">
                    ...
                    <div class="mt-5">
                        <a class="btn custom-book-appointment-btn" role="button" href="{{ route('appointment.back') }}">
                            BOOK AN APPOINTMENT
                        </a>
                        <a class="btn custom-btn-check-schedule" role="button" href="{{ url('/user_appointment') }}">
                            CHECK SCHEDULE
                        </a>
                    </div>
                </div>
