            ...
            <div class="col-md-4 forgot-pass mt-5">
                <div id="initialState">
                    <div class="d-flex flex-column" style="height: 100%;">
                        <div class="d-flex justify-content-between mb-5 mt-3">
                            ...
                            <a href="{{ route('auth.signup') }}" style="text-decoration: none;"> <button class="custom-create-acc-btn">Create Account</button></a>
                        </div>
                        ...
                        <form id="forgotPassword_Form" method="POST" action="{{ route('auth.forgotpassword.submit') }}" class="mb-5">
                            @csrf
                ...
                <div id="changedState" class="d-none">
                    <div class="d-flex flex-column" style="height: 100%; width: 100%">
                        ...
                        <form id="resetCode_Form" method="POST" action="{{ route('auth.resetcode.submit') }}">
                            @csrf
                ...
                <div id="passwordState" class="d-none">
                    <div class="d-flex flex-column" style="height: 100%; width: 100%">
                        ...
                        <form id="resetPassword_Form" method="POST" action="{{ route('auth.passwordreset') }}">
                            @csrf
                ...
                <div id="finalState" class="d-none">
                    <div class="d-flex flex-column" style="height: 100%;">
                        ...
                        <div class="text-center">
                            <a href="{{ route('clients.signin') }}" style="text-decoration: none;"><button class="btn custom-reset-btn mb-2">Sign In</button></a>
                            <a href="{{ route('auth.signup') }}" style="text-decoration: none;"><button class="btn custom-reset-btn">Create New Account</button></a>
                        </div>
                    </div>
                </div>
            </div>
