					...
					<div id="step-1" class="step active">
						<div class="justify-content-between vet_logo_btn_container">
							<div class="vet_logo"><img src="{{ asset('assets/img/dogs_cats.png') }}">
								<h1>Tagapo Dogs &amp; Cats Veterinary Clinic</h1> </div>
							...
							<div class="signup_inputs_container">
								<div class="input-group">
									...
									<div class="form-floating custom_form_floating">
										...
										<div id="guide_email_message" class="guide-message"><span>• Please enter your email.<br>(e.g. pogiako@gmail.com/pogiako@yahoo.com)</span></div>
										<div id="error-email" class="error-message"><span>• Please enter your Email Address.</span><span>• Invalid email format.</span></div>
									</div>
								</div>
								<div class="input-group">
									<div class="input_svg">
									...
									<div class="form-floating custom_form_floating">
										...
										<div id="error-phone_number" class="error-message"><span>• Please enter your phone number.</span></div>
										<div id="guide_phone_number" class="guide-message"><span>• Please enter 1-11 digits only. (e.g., 09172839117)</span></div>
									</div>
								</div>
								<div class="input-group">
									<div class="input_svg">
									...
									<div class="align-self-stretch form-floating custom_form_floating">
										...
										<div id="eye-icon" class="eye-icon" onclick="togglePasswordVisibility()">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
												<g opacity="0.5" clip-path="url(#clip0_6078_13948)">
													<path d="M21 9C18.6 11.667 15.6 13 12 13C8.4 13 5.4 11.667 3 9M3 15L5.5 11.2M20.9998 14.976L18.5078 11.2M9 17L9.5 13M15 17L14.5 13" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /> </g>
												<defs>
										...
										<div id="error-password" class="error-message"><span>• Please enter your password.</span><span>• Password must have 8 or more characters.</span><span>• Password must have at least 1 uppercase character.</span><span>• Password must have at least 1 special character.</span></div>
										<div id="guide_password" class="guide-message"><span>• Password must have more than 8 characters.</span><span>• Password must have at least 1 uppercase character.</span><span>• Password must have at least 1 special character.</span></div>
									</div>
								</div>
								<div class="input-group">
									<div class="input_svg">
									...
									<div class="align-self-stretch form-floating custom_form_floating">
										...
										<div id="error-password_confirmation" class="error-message"><span>•&nbsp;Please enter your password first.</span></div>
										<div id="error-password_confirmation_1" class="error-message"><span>• Password does not match.</span></div>
										<div id="guide_password_confirmation" class="guide-message"><span>• Password and Repeat Password must be matched.</span></div>
									</div>
								</div>
							</div>
						...
						<div class="justify-content-between signup_header" id="signup_header">
							<button id="signup_back_btn" class="signup_back_btn" type="button">
								<svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
									<path d="M5.5 12H19.5M5.5 12L11.5 18M5.5 12L11.5 6" stroke="#045B62" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
