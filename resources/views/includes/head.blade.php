            ...
            <!-- <ul>
                <div class="first_group">
                    ...
                    <a href="{{ route('admin_appointment') }}">
                        <li  class="{{ $activeTab === 'approved' ? 'active' : '' }}" data-tab="approved"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="sidebar_group">
                    ...
                    <a href="{{ route('admin_emr') }}">
                        <li  class="{{ $activeTab === 'emr' ? 'active' : '' }}" data-tab="emr"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <a href="{{ route('admin_client') }}">
                        <li class="{{ $activeTab === 'clients' ? 'active' : '' }}" data-tab="clients"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <a href="{{ route('admin_inv') }}" >
                    
                    <li class="{{ $activeTab === 'inventory' ? 'active' : '' }}" data-tab="inventory"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
