...
<a href="{{ route('admin_dashboard') }} "> Dashboard</a></li>
                        <li class="list-inline-item  {{ $activeTab === 'appointment' ? 'active' : '' }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<a href="{{ route('admin_appointment') }}">Appointments</a></li>
                    </ul>
                    <hr class="line_separator">
                    <ul class="list-inline second_group">
                        <li class="list-inline-item {{ $activeTab === 'emr' ? 'active' : '' }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<a href="{{ route('admin_emr') }}">Pet Records</a></li>
                        <li class="list-inline-item {{ $activeTab === 'client' ? 'active' : '' }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<a href="{{ route('admin_client') }}">Clients</a></li>
                        <li class="list-inline-item {{ $activeTab === 'inventory' ? 'active' : '' }}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
